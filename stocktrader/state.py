...
class Position:
    ...
    entry_fx_fee_eur: float = 0.0  # deprecated — gebruik entry_eur_cost
    entry_eur_cost: float = 0.0    # EUR betaald bij entry (T212 buy-rate)
        ...
        return {
            ticker: Position(**{
                **pos,
                ...
                "entry_eur_cost": pos.get("entry_eur_cost", 0.0),
            })
